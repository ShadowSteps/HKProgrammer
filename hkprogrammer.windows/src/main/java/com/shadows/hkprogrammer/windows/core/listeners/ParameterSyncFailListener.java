...
import com.shadows.hkprogrammer.windows.core.tasks.ParameterSyncFailUITask;
 ...
 * @author John
 */
public class ParameterSyncFailListener extends ATaskOnErrorListener {
    @Override
    public void onError(TaskOnErrorEvent result) {
        Platform.runLater(new ParameterSyncFailUITask());                
    }
}
